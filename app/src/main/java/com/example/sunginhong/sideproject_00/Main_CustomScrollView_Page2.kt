...
import com.example.sunginhong.sideproject_00.Main_Fragment_Page2.Companion.scrollCardHeight
...
//        main_scrollview_page2.scrollTo(0, scrollY)
    ...
    fun cardAnim () {
        for (i in 0 until Main_Fragment_Page2.frag2_rv_Array.size) {
            if (scrolledDistance - Main_Fragment_Page2.frag2_rv_Array[i]!!.y < 0 && scrolledDistance - Main_Fragment_Page2.frag2_rv_Array[i]!!.y > -Main_Fragment_Page2.frag2_rv_Array[i]!!.height / 0.0) {
                if (Main_Fragment_Page2.frag2_rv_Array[i]!!.y === Main_Fragment_Page2.frag2_rv_Array_Ypos[i]!! + scrollCardHeight.toFloat()) {
                    ...
                    Utils_Animation.TransAnim(Main_Fragment_Page2.frag2_rv_Array[i]!!, 0f, 0f, Main_Fragment_Page2.frag2_rv_Array_Ypos[i]!! + scrollCardHeight/scrollRate, 0f, 500)
                }
            }
            if (scrolledDistance - Main_Fragment_Page2.frag2_rv_Array[i]!!.y < 0 && scrolledDistance - Main_Fragment_Page2.frag2_rv_Array[i]!!.y < -Main_Fragment_Page2.frag2_rv_Array[i]!!.height/ 0.6) {
                if (Main_Fragment_Page2.frag2_rv_Array[i]!!.y === Main_Fragment_Page2.frag2_rv_Array_Ypos[i]!!) {
                    Utils_Animation.TransAnim(Main_Fragment_Page2.frag2_rv_Array[i]!!, 0f, 0f, 0f, Main_Fragment_Page2.frag2_rv_Array_Ypos[i]!! + scrollCardHeight/scrollRate, 0)
